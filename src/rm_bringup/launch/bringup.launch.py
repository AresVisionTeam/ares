...
# 禁用深度压缩插件，避免错误日志（在系统级别设置）
os.environ['IMAGE_TRANSPORT_PLUGIN_BLACKLIST'] = 'compressed_depth'
...
def generate_launch_description():
    ...
    # 禁用深度压缩插件，避免错误日志
    set_env_var = SetEnvironmentVariable('IMAGE_TRANSPORT_PLUGIN_BLACKLIST', 'compressed_depth')
