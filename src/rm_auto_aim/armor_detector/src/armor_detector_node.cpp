...
std::unique_ptr<Detector> ArmorDetectorNode::initDetector() {
  ...
  fs::path network_path = utils::URLResolver::getResolvedPath(
      "package://armor_detector/model/best_06_02.xml");
  ...
  detector->ov_detector = std::make_unique<ArmorDetector>(network_path);
  // Init Corrector
