...
public:
  ...
  std::string getErrorMessage() override { return send_packet_tool_->getErrorMessage(); }

private:
 // FixedPacketTool<16>::SharedPtr packet_tool_;
  FixedPacketTool<16>::SharedPtr send_packet_tool_;
  FixedPacketTool<20>::SharedPtr receive_packet_tool_;
